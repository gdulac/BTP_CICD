		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#logaligprojectfiorictm-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligprojectfiorictm-display": {
								"semanticObject": "logaligprojectfiorictm",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logalig.projectfiorictm",
									"url": sap.ui.require.toUrl("logalig/projectfiorictm")
								}
							}
						}
					}
